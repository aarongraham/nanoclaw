...
# Aliases for Pi-hole group IDs (see home-server docs/pihole-api-reference.md
# §"Current Group Structure"). Order matters: IoT is matched before
# "personal" so "iot" doesn't get swallowed by the ad-blocking pattern.
_GROUP_ALIASES = [
